...
<head>
  ...
  <title>D-Táxi | Manual de Operações – Congonhas</title>
  <meta name="description" content="Manual de Operações da D-Táxi no Aeroporto de Congonhas – versão interativa e responsiva."/>
  <meta name="author" content="D-Táxi" />
  <meta name="keywords" content="D-Táxi, Congonhas, Manual de Operações, Táxi Aeroporto, Regras Táxi" />
</head>
<body>
    <section id="intro">
      <h2>Manual de Operações</h2>
      <p><strong>Aeroporto de Congonhas.</strong></p>
    ...
    <section id="padrao">
      <h2>Padrão Operacional Obrigatório</h2>
    ...
    <section id="estrutura">
      <h2>1. A Estrutura da Fila e a Localização dos PAs</h2>
    ...
    <section id="fluxo">
      <h2>2. Fluxo de Trabalho e Regras por Ponto de Apoio</h2>
      <details>
        <summary>PA5 (Ponto de Entrada)</summary>
        <div>
      ...
      <details>
        <summary>Bolsão Principal (Ponto de Espera)</summary>
        <div>
          <ul>
      ...
      <details>
        <summary>PA3 (Ponto Estratégico)</summary>
        <div>
          <ul>
      ...
      <details>
        <summary>PA2 (Ponto Final de Espera)</summary>
        <div>
          <ul>
      ...
      <details>
        <summary>Piso Inferior (Área de Embarque)</summary>
        <div>
          <ul>
      ...
      <details>
        <summary>Piso Superior (PA-0) – Área de Embarque</summary>
        <div>
          <ul>
    ...
    <section id="pagamentos">
      <h2>3. Pagamentos e Cobranças</h2>
    ...
    <section id="bolinhas">
      <h2>4. Observações sobre o Sistema de Bolinhas</h2>
      <ul>
    ...
    <section id="regras">
      <h2>5. Regras Gerais e Cenários Específicos</h2>
      <details>
        <summary>Fila Única</summary>
        <div>
          <ul>
    ...
    <section id="pda">
      <h2>6. Manual do Aplicativo PDA</h2>
      <p><strong>Guia completo para uso do sistema digital D-Táxi.</strong></p>
      ...
      <details>
        <summary>Tela Principal e Status</summary>
        <div>
          <ul>
